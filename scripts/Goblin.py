...
class Goblin(pygame.sprite.Sprite):
  def __init__(self, x, y, player,coin_group):
    ...
    self.animations = {
      "attack": load_and_resize_frames(pygame.image.load("assets/sprites/goblin/attack/Attack.png").convert_alpha(), 0, 8, 150, 150, scale=2),
      "death":  load_and_resize_frames(pygame.image.load("assets/sprites/goblin/death/Death.png").convert_alpha(), 0, 4, 150, 150, scale=2),
      "walk":   load_and_resize_frames(pygame.image.load("assets/sprites/goblin/walk/Walk.png").convert_alpha(), 0, 8, 150, 150, scale=2),
      "idle":   load_and_resize_frames(pygame.image.load("assets/sprites/goblin/idle/Idle.png").convert_alpha(), 0, 4, 150, 150, scale=2),
      "hit":    load_and_resize_frames(pygame.image.load("assets/sprites/goblin/hurt/Hurt.png").convert_alpha(), 0, 3, 150, 150, scale=2),
    }
