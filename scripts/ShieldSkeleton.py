...
class ShieldSkeleton(pygame.sprite.Sprite):
  def __init__(self, x, y, player,coin_group):
    ...
    self.animations = {
      "attack": load_and_resize_frames(pygame.image.load("assets/sprites/skeletonL2/attack/Attack.png").convert_alpha(), 0, 8, 150, 150, scale=2),
      "death":  load_and_resize_frames(pygame.image.load("assets/sprites/skeletonL2/death/Death.png").convert_alpha(), 0, 4, 150, 150, scale=2),
      "walk":   load_and_resize_frames(pygame.image.load("assets/sprites/skeletonL2/walk/Walk.png").convert_alpha(), 0, 4, 150, 150, scale=2),
      "idle":   load_and_resize_frames(pygame.image.load("assets/sprites/skeletonL2/idle/Idle.png").convert_alpha(), 0, 4, 150, 150, scale=2),
      "hit":    load_and_resize_frames(pygame.image.load("assets/sprites/skeletonL2/hurt/Hurt.png").convert_alpha(), 0, 4, 150, 150, scale=2),
    }
  ...
  def get_attack_hitbox(self):
    width = 150
    height = self.rect.height - 200
    new_top = self.rect.top + 100
